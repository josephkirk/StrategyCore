...
struct STRATEGYCOREMODULERUNTIME_API FStrategyResource
{
	GENERATED_BODY()
...
class STRATEGYCOREMODULERUNTIME_API UStrategyResourceData: public UDataAsset
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct STRATEGYCOREMODULERUNTIME_API FStrategyResourceConfig
{
	GENERATED_BODY()
...
UCLASS(BlueprintType)
class STRATEGYCOREMODULERUNTIME_API UStrategyResourcesConfig : public UDataAsset
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct STRATEGYCOREMODULERUNTIME_API FStrategyResourceInfo
{
	GENERATED_BODY()
...
UCLASS(BlueprintType)
class STRATEGYCOREMODULERUNTIME_API UStrategyResourcesConversionMapping : public UDataAsset
{
	GENERATED_BODY()
...
UCLASS(BlueprintType)
class STRATEGYCOREMODULERUNTIME_API UStrategyResourcesGameData : public UDataAsset
{
	GENERATED_BODY()
